      ...
      <el-container>
        ...
        <el-header>
          <el-row type="flex" class="row-bg" justify="space-around">
            ...
            <el-col :span="6"><div class="grid-content bg-purple">
              <el-avatar :size="40" fit="fit" src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3417121378,1487501826&fm=26&gp=0.jpg"></el-avatar>
              <span>欢迎监狱长：</span>
...
import subMenu from '../../../../ls-xm/sys_v2.0/src/components/subMenu.vue';
export default {
  components: { subMenu },
  data() {
    return {
